...
<@html.html>
    <@html.head title='Выдача постановлений по присвоению адреса земельным участкам и объектам капитального строительства'>
        <@script.scripttag>
            ...
            <#--включение поле otherDocTypeName, если выбран тип документа 5-->
            <@action.setVisibleByValue onload='true' srcid='identitiDocType' event='change' destid='otherDocTypeName' value='5'/>
        ...
        <@sf.serviceForm>
            ...
            <@sf.serviceStepForm withFileUpload=true includeEmptyTr=true>
                ...
                <@sf.fldrow>
                    ...
                    <@sf.textfield  path="form.lastName" qtip="Допустимо вносить только кириллические буквы, пробел и знак дефиса" validation="required cyrillic" wrapperClass='fieldDisabled' attr='readonly="readonly"' style="text-align:left;" colspan="31"/>
                </@sf.fldrow>

                <@sf.fldrow>
                    <@sf.label path="form.firstName" title="Имя:" required=true style="text-align:left;" colspan="17"/>
                    <@sf.textfield  path="form.firstName" qtip="Допустимо вносить только кириллические буквы, пробел и знак дефиса" validation="required cyrillic" wrapperClass='fieldDisabled' attr='readonly="readonly"' style="text-align:left;" colspan="31"/>
                </@sf.fldrow>

                <@sf.fldrow>
                    <@sf.label path="form.middleName" title="Отчество (если имеется):" required=false style="text-align:left;" colspan="17"/>
                    <@sf.textfield  path="form.middleName" qtip="Допустимо вносить только кириллические буквы, пробел и знак дефиса" validation="required"  wrapperClass='fieldDisabled' attr='readonly="readonly"' style="text-align:left;" colspan="31"/>
                </@sf.fldrow>
...
<@sf.statictext style="text-align:left;" colspan="48"><h2>Сведения о почтовом адресе заявителя</h2></@sf.statictext>
               ...
               <@address.block_country_form fieldsMap=fieldsMap country='addressPostCountry' countryCode='addressPostCountryCode' input='addressPostEnterType' country_input='addressPostCountryInput'
                ...
                <@sf.fldrow>
                    <@sf.fileload path="form.identityDocLoad" validation="required" qtip="" validation="required" fileExtensions="PDF,DOC,DOCX,XLS,XLSX,JPG,JPEG,PNG,MDI,TIFF,ODT,ODS" style="text-align:left;" colspan="48"/>
                </@sf.fldrow>
