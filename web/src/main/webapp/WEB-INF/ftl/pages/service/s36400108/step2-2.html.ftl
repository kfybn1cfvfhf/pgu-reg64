...
<@sf.radiogroup path="form.sex" staticOpts={'1':'Мужской','2':'Женский'} qtip="" validation="required" colspan="15" mode="horizontal"  attr='readonly="true"' wrapperClass='fieldDisabled'/>
