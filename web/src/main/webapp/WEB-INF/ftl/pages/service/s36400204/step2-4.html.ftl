...
Валидация: cyrillic (кириллические буквы, пробел и знак дефиса)-->
                    <@sf.textfield  path="form.lastName" qtip="Допустимо вносить только кириллические буквы, пробел и знак дефиса" wrapperClass='fieldDisabled' attr='readonly="readonly"' validation="required" style="text-align:left;" colspan="31"/>
...
Валидация: cyrillic (кириллические буквы, пробел и знак дефиса)-->
                    <@sf.textfield  path="form.firstName" qtip="Допустимо вносить только кириллические буквы, пробел и знак дефиса" wrapperClass='fieldDisabled' attr='readonly="readonly"' validation="required" style="text-align:left;" colspan="31"/>
...
данные из ЛК
Недоступно для редактирования-->
                    <@sf.datefield path="form.birthdate"  qtip="" validation="required" wrapperClass='fieldDisabled' attr='readonly="readonly"' style="text-align:left;" colspan="31"/>
...
Валидация: email-->
                ...
                <#-- блок: factAddress-->
                    <@sf.statictext style="text-align:left;" colspan="48"><h2>Сведения о месте жительства (пребывания)
                        законного представителя лица, нуждающегося в услуге</h2>
                    </@sf.statictext>
