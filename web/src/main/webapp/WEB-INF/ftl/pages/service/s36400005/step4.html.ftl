        ...
        <@script.scripttag>
            <@jquery.onready>
                if($('#filial').attr('checked')==true)  {
                    $('#load_doc10').parentsUntil('tbody','tr').css('display','table-row').prev().css('display','table-row');
                } else {
                    $('#load_doc10').parentsUntil('tbody','tr').css('display','none').prev().css('display','none');
                }
        ...
        <@sf.serviceForm>
            ...
            <@sf.serviceStepForm withFileUpload=true >
                ...
                <@sf.fldrow>
                    ...
                    <@sf.label title="Переоформление Свидетельства о государственной аккредитации в отношении филиала" required=false style="text-align:left;" colspan="48"/>
                </@sf.fldrow>
                <@sf.fldrow>
                ...
                <@docFields.load_doc11 />

                <@docFields.load_doc10 />
                <@docFields.load_doc13 />
