        ...
        <@sf.serviceForm>
            ...
            <@sf.serviceStepForm withFileUpload=true includeEmptyTr=true>
                ...
                <@sf.fldrow>
                    ...
                    <@sf.statictext style="text-align:left;" colspan="48"><h2>Дополнительные сведения, необходимые для
                        предоставления услуги</h2></@sf.statictext>
...
2. скрывается в случае выбора в параметре #accrualMethod значения "2. Посредством отделения почтовой связи"-->
                    <@sf.statictext attr='id="bankingDetailsLabel"'style="text-align:left;" colspan="48"><h2>Сведения о банковских
                        реквизитах</h2></@sf.statictext>
...
Логика: Отображается в случае выбора в параметре #accrualMethod значения "1. На расчётный счет"-->
                ...
                <#-- По умолчанию: скрыто Логика: Отображается в случае выбора в параметре #accrualMethod значения "1. На расчётный счет"-->
...
Валидатор: XXXXXXXXX, где X - одна обязательная цифра (9 цифр)-->
                    ...
                    <@sf.textfield  path="form.bikBankBenefit" qtip="Вносится в формате XXXXXXXXX, где X - одна обязательная цифра (9 цифр)" validation="required digitsexact" validationattr={'digitsexact':9} style="text-align:left;" colspan="31"/>
...
Валидатор: XXXXXXXXXXXXXXXXXXXX где X - одна обязательная цифра (20 цифр)-->
                    ...
                    <@sf.textfield  path="form.corrAccBankBenefit" qtip="Вносится в формате XXXXXXXXXXXXXXXXXXXX где X - одна обязательная цифра (20 цифр)" validation="required digitsexact" validationattr={'digitsexact':20} style="text-align:left;" colspan="31"/>
...
Валидатор: XXXXXXXXXXXXXXXXXXXX где X - одна обязательная цифра (20 цифр)-->
                    <@sf.label path="form.clientAccBankBenefit" title="Номер расчетного (лицевого) счета:" required=true style="text-align:left;" colspan="17"/>
...
2. скрывается  в случае выбора в параметре #accrualMethod значения "1. На расчётный счет"-->
                    <@sf.statictext attr='id="addressBenefitLabel"' style="text-align:left;" colspan="48"><h2>Сведения о почтовом
                        отделении</h2></@sf.statictext>
...
2. скрывается  в случае выбора в параметре #accrualMethod значения "1. На расчётный счет"-->
                ...
                <#-- Валидатор: PDF, DOC, DOCX, XLS, XLSX, JPG, JPEG, PNG, MDI, TIFF, ODT, ODS.-->
                    <@sf.label path="form.honoraryCitizenLoad" title="Удостоверение Почётного гражданина Саратовской области:" required=true style="text-align:left;" colspan="48"/>
                ...
                <#-- Валидатор: PDF, DOC, DOCX, XLS, XLSX, JPG, JPEG, PNG, MDI, TIFF, ODT, ODS.-->
                    <@sf.fileload path="form.honoraryCitizenLoad" fileExtensions="PDF,DOC,DOCX,XLS,XLSX,JPG,JPEG,PNG,MDI,TIFF,ODT,ODS" validation="required" qtip="" style="text-align:left;" colspan="48"/>
                ...
                <#-- Валидатор: PDF, DOC, DOCX, XLS, XLSX, JPG, JPEG, PNG, MDI, TIFF, ODT, ODS.-->
                    <@sf.label path="form.certificateLackSupportLoad" title="Справка о неполучении мер социальной поддержки по другим основаниям при наличии нескольких льготных статусов из территориального органа Пенсионного Фонда Российской Федерации по Саратовской области:" required=false style="text-align:left;" colspan="48"/>
                ...
                <#-- Валидатор: PDF, DOC, DOCX, XLS, XLSX, JPG, JPEG, PNG, MDI, TIFF, ODT, ODS.-->
                    <@sf.fileload path="form.certificateLackSupportLoad" fileExtensions="PDF,DOC,DOCX,XLS,XLSX,JPG,JPEG,PNG,MDI,TIFF,ODT,ODS" qtip="" style="text-align:left;" colspan="48"/>

                </@sf.fldrow>

                <@sf.fldrow>

                    <@sf.label path="form.agreementApplicant" title="В случае изменения обстоятельств, влияющих  на выплату компенсаций, обязуюсь сообщить в Министерство в 5-ти дневный срок:" required=true style="text-align:left;" colspan="17"/>

                    <@sf.checkbox path="form.agreementApplicant" qtip="" validation="required" style="text-align:left;" colspan="31"/>
