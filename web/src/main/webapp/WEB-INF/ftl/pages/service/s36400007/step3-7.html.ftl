...
<@html.html>
    <@html.head title='Предоставление лицензии на осуществление медицинской деятельности'>
        <@script.scripttag>
            ...
            <@action.cloneFormRowWithArrays clonesectionclass='load_doc12' hideButtonSections='true'/>
...
Валидатор: PDF, DOC, DOCX, XLS, XLSX, JPG, JPEG, PNG, MDI, TIFF, ODT, ODS.-->
<@sf.label path="form.load_doc12" title="Копии документов об образовании (послевузовском, дополнительном профессиональном образовании, повышении квалификации) и документы, подтверждающие стаж работы руководителя юридического лица или его заместителя:" required=true style="text-align:left;" colspan="48"/>
					
                </@sf.fldrow>
				
<@sf.initAllClones formElement=form.load_doc12 cloneSectionClass='load_doc12' ; x>
                    <@sf.fldrow class="load_doc12">
                        <@sf.fileload path="form.load_doc12[${x}]" fileExtensions="PDF,DOC,DOCX,XLS,XLSX,JPG,JPEG,PNG,MDI,TIFF,ODT,ODS" validation="required" qtip="" style="text-align:left;" colspan="48"/>
                    </@sf.fldrow>
                    <@sf.fldrow class="load_doc12">
...
<@sf.fileload path="form.load_doc3" fileExtensions="PDF,DOC,DOCX,XLS,XLSX,JPG,JPEG,PNG,MDI,TIFF,ODT,ODS" qtip="" style="text-align:left;" colspan="48"/>
                ...
                <@sf.fldrow>
						...
						<#-- Множественная загрузка
Логика: по умолчанию скрыто
1. Отображается при активировации чекбокса #ownership
2. Скрывается при деактивировации чекбокса #ownership
Валидатор: PDF, DOC, DOCX, XLS, XLSX, JPG, JPEG, PNG, MDI, TIFF, ODT, ODS.-->
