            ...
            <@sf.serviceStepForm  >
			    <@sf.initAllClones formElement=form.licensAdress_1 cloneSectionClass="clonesection-licenseobject" ; x>
                    ...
                    <@sf.fldrow class="clonesection-licenseobject">
                            ...
                            <@sf.textarea path="form.licensAdress_1[${x}]" qtip="" validation="required" class="clone-field" style="text-align:left;" colspan="36"/>
                    ...
                    <@sf.fldrow class="clonesection-licenseobject">
                            ...
                            <@sf.addRemoveButton addTitle="Добавить объект" delTitle="Удалить объект" colspan="48"/>
