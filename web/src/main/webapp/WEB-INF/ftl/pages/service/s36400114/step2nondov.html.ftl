    ...
    <@html.head title='Выплата ежемесячного пособия по уходу за ребенком'>
        <@script.scripttag>
            <@jquery.onready>
                ...
                <@action.setVisibleByValue onload="true"  srcid="politicalNationality" event="change" value="2,3,4" destid="bezhDocLoad" scope="LBL+EL+ROW"/>
                <@action.unsetDisabledByValue onload="true" srcid="politicalNationality" event="change" value="2,3,4" destid="bezhDocLoad"  />
                <@action.setVisibleByValue onload="true"  srcid="politicalNationality" event="change" value="2,3" destid="timeDocLoad" scope="LBL+EL+ROW"/>
                <@action.unsetDisabledByValue onload="true" srcid="politicalNationality" event="change" value="2,3" destid="timeDocLoad"  />
...
<@sf.statictext style="text-align:left;" colspan="48"><h2>Адрес места жительства (пребывания)</h2></@sf.statictext>
...
Электронная копия каждого документа  должна представлять собой один файл в формате PDF, DOC, DOCX, XLS, XLSX, JPG, JPEG, PNG, MDI, TIFF, ODT, ODS, содержащий отсканированный графический образ соответствующего бумажного документа, заверенного надлежащим образом и снабженного всеми необходимыми подписями и печатями.
                ...
                <@sf.fldrow>
<@sf.label path="form.bezhDocLoad" title="Документ, удостоверяющий личность, с отметкой о выдаче вида на жительство или удостоверение беженца:" required=true style="text-align:left;" colspan="48"/>
                </@sf.fldrow>
				
                <@sf.fldrow>
<@sf.fileload path="form.bezhDocLoad" qtip="" validation="required" fileExtensions="PDF,DOC,DOCX,XLS,XLSX,JPG,JPEG,PNG,MDI,TIFF,ODT,ODS" style="text-align:left;" colspan="48"/>
                </@sf.fldrow>
				
                <@sf.fldrow>
<@sf.label path="form.timeDocLoad" title="Разрешение на временное проживание по состоянию на 31 декабря 2006 года:" required=true style="text-align:left;" colspan="48"/>
                </@sf.fldrow>
				
                <@sf.fldrow>
<@sf.fileload path="form.timeDocLoad" qtip="" validation="required" fileExtensions="PDF,DOC,DOCX,XLS,XLSX,JPG,JPEG,PNG,MDI,TIFF,ODT,ODS" style="text-align:left;" colspan="48"/>
                </@sf.fldrow>
