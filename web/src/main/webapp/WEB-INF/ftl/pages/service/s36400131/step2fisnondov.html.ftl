...
<@sf.datefield path="form.birthdate"  qtip="" validation="required" style="text-align:left;" attr='readonly="readonly"' colspan="31"/>
                </@sf.fldrow>
...
<@sf.statictext style="text-align:left;" colspan="48"><h2>Сведения о почтовом адресе заявителя</h2></@sf.statictext>
                ...
                <@sf.fldrow>
						...
						<@sf.statictext style="text-align:left;" colspan="48"><h2>Сведения о паспортных данных заявителя</h2></@sf.statictext>
					
                </@sf.fldrow>
				
                <@sf.fldrow>
<@sf.label path="form.passSeria" title="Серия:" required=true style="text-align:left;" colspan="17"/>
<@sf.textfield  path="form.passSeria" qtip="Вносится в формате XXXX, где X - одна обязательная цифра (4 цифры)" validation="digitsexact required" validationattr={'digitsexact':4} style="text-align:left;" colspan="31"/>
                </@sf.fldrow>
				
                <@sf.fldrow>
<@sf.label path="form.passNo" title="Номер:" required=true style="text-align:left;" colspan="17"/>
<@sf.textfield  path="form.passNo" qtip="Вносится в формате XXXXXX, где X - одна обязательная цифра (6 цифр)" validation="digitsexact required" validationattr={'digitsexact':6} style="text-align:left;" colspan="31"/>
                </@sf.fldrow>
