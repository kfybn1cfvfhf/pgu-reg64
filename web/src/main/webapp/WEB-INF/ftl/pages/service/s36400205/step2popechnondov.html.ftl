...
<@sf.fileload path="form.dovOpekLoad" qtip="" validation="required" fileExtensions="PDF,DOC,DOCX,XLS,XLSX,JPG,JPEG,PNG,MDI,TIFF,ODT,ODS" style="text-align:left;" colspan="48"/>
                ...
                <@sf.fldrow>
						...
						<@sf.statictext style="text-align:left;" colspan="48"><h2>Сведения об опекуне (попечителе) лица, нуждающегося в услуге</h2></@sf.statictext>
...
Могут быть изменены в ходе заполнения формы заявления.</i></@sf.statictext>
                ...
                <@sf.fldrow>
						...
						<@sf.statictext style="text-align:left;" colspan="48"><h2>Контакты опекуна (попечителя) лица, нуждающегося в услуге</h2></@sf.statictext>
                ...
                <@sf.fldrow>
						...
						<#-- блок: address-->
<@sf.statictext style="text-align:left;" colspan="48"><h2>Сведения о месте регистрации опекуна (попечителя) лица, нуждающегося в услуге</h2></@sf.statictext>
                ...
                <@sf.fldrow>
						...
						<#-- блок: factAddress-->
<@sf.statictext style="text-align:left;" colspan="48"><h2>Сведения о месте жительства (пребывания) опекуна (попечителя) лица, нуждающегося в услуге</h2></@sf.statictext>
...
Электронная копия каждого документа  должна представлять собой один файл в формате PDF, DOC, DOCX, XLS, XLSX, JPG, JPEG, PNG, MDI, TIFF, ODT, ODS, содержащий отсканированный графический образ соответствующего бумажного документа, заверенного надлежащим образом и снабженного всеми необходимыми подписями и печатями.
                ...
                <@sf.fldrow>
                    <@sf.label path="form.identityDocLoad" title="Документ, удостоверяющий личность родителя лица, нуждающегося в услуге:" required=true style="text-align:left;" colspan="48"/>
                </@sf.fldrow>
