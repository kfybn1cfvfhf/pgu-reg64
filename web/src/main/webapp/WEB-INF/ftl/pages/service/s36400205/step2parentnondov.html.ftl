        ...
        <@sf.serviceForm>
            ...
            <@sf.serviceStepForm withFileUpload=true includeEmptyTr=true>
                ...
                <@sf.fldrow>
						...
						<@sf.statictext style="text-align:left;" colspan="48"><h2>Сведения о родителе лица, нуждающегося в услуге</h2></@sf.statictext>
...
Могут быть изменены в ходе заполнения формы заявления.</i></@sf.statictext>
                ...
                <@sf.fldrow>
						...
						<@sf.statictext style="text-align:left;" colspan="48"><h2>Контакты родителя лица, нуждающегося в услуге</h2></@sf.statictext>
                ...
                <@sf.fldrow>
						...
						<#-- блок: address-->
<@sf.statictext style="text-align:left;" colspan="48"><h2>Сведения о месте регистрации родителя лица, нуждающегося в услуге</h2></@sf.statictext>
                ...
                <@sf.fldrow>
						...
						<#-- блок: factAddress-->
<@sf.statictext style="text-align:left;" colspan="48"><h2>Сведения о месте жительства (пребывания) родителя лица, нуждающегося в услуге</h2></@sf.statictext>
