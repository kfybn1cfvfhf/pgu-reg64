...
Логика
Скрывается при активации чекбокса #dov_enable-->
...
1. Выйти из учетной записи и авторизоваться заново под вашим логином и паролем;
...
Очищается и дается доступ для редактирования при активации чек-бокса #dov_enable
Валидация: кириллические буквы и знак дефиса-->
<@sf.radiogroup mode="horizontal"  path="form.sex" qtip="" staticOpts={"1":"Мужской", "2":"Женский"} validation="required" attr='readonly="readonly"' wrapperClass='fieldDisabled' style="text-align:left;" colspan="31"/>
...
Логика
Скрывается при активации чекбокса #dov_enable-->
<@sf.statictext style="text-align:left;" colspan="48"><i>Поля «Адрес регистрации», «Адрес места жительства (пребывания)» «Контактный телефон», «Адрес электронной почты» заполняются на основании учетной записи на портале. 
