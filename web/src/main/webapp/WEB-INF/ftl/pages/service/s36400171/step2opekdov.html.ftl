...
<@sf.statictext style="text-align:left;" colspan="48"><h2>Сведения о месте регистрации законного представителя лица, нуждающегося в услуге</h2></@sf.statictext>
                ...
                <@sf.fldrow>
                        ...
                        <@sf.textfield  path="form.email" qtip="Вносится в формате: name@site.domain"  style="text-align:left;" colspan="31"/>
                </@sf.fldrow>
                ...
                <@sf.fldrow>
                        <@sf.label path="form.identityDocLoad" title="Паспорт, удостоверяющий личность законного представителя лица, нуждающегося в услуге:" required=true style="text-align:left;" colspan="48"/>
                </@sf.fldrow>
