...
<br>2. В случае необходимости внести изменения в учетную запись в установленном порядке.</i></@sf.statictext>
                ...
                <@sf.fldrow>
                    ...
                    <@sf.radiogroup mode="horizontal" staticOpts={"1":"Мужской", "2":"Женский"} path="form.sex" attr="readonly='readonly'" wrapperClass="fieldDisabled" qtip="" validation="required"  style="text-align:left;" colspan="18"/>
