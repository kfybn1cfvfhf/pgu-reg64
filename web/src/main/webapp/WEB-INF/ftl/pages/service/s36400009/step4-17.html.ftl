...
<@sf.label path="form.load_doc22" title="Адреса мест, по которым изменяются виды работ (услуг), с указанием прекращаемых выполняемых видов работ и услуг:" required=true style="text-align:left;" colspan="48"/>
					
                </@sf.fldrow>
				
                <@sf.fldrow>

<@sf.fileload path="form.load_doc22" validation="required" fileExtensions="PDF,DOC,DOCX,XLS,XLSX,JPG,JPEG,PNG,MDI,TIFF,ODT,ODS" qtip="Вносится файл приложения к заявлению с перечислением мест, где изменяются виды работ и услуг c целью прекращения" style="text-align:left;" colspan="48"/>
...
<@sf.fileload path="form.load_doc3" qtip="" style="text-align:left;" colspan="48"/>
