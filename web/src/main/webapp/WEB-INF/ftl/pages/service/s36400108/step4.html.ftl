...
<@html.html>
    <@html.head title='Прием заявлений, постановка на учет и предоставление информации об организации оказания специализированной медицинской помощи в специализированных медицинских учреждениях'>
        <@script.scripttag>
            <@jquery.onready>
			<@action.setVisibleByValue 'true' 'grInvalid' 'change' 'fullLifeInvalid' '1,2,3'/>
            </@jquery.onready>
        </@script.scripttag>
    </@html.head>
    <@html.body>
        ...
        <@sf.serviceForm>
            ...
            <@sf.serviceStepForm withFileUpload=true includeEmptyTr=true>
                ...
                <@sf.fldrow>
						...
						<@sf.statictext style="text-align:left;" colspan="48"><h2>Сведения об инвалидности лица, нуждающегося в услуге</h2></@sf.statictext>
					
                </@sf.fldrow>

                <@sf.fldrow>

                    <@sf.label path="form.grInvalid" title="Инвалидность лица, нуждающегося в услуге:" required=false style="text-align:left;" colspan="17"/>

                    <@sf.staticLookup  path="form.grInvalid" staticData={"1":"I группа",
                                                                         "2":"II группа",
                                                                         "3":"III группа",
                                                                         "4":"Ребенок-инвалид"}
                        qtip="Указать инвалидность лица, нуждающегося в услуге, при наличии" style="text-align:left;" colspan="30"/>
