        ...
        <@sf.serviceForm>
            ...
            <@sf.serviceStepForm  >
                ...
                <@sf.fldrow>
						...
						<#-- Допускается ввод только цифровых символов. Корректный номер состоит из 15-ти символов.  Валидатор - ОГРНИП-->
                        <@sf.label title="Государственный регистрационный номер записи о государственной регистрации индивидуального предпринимателя (ОГРНИП):" required=true style="text-align:left;" colspan="11"/>

						<@sf.empty colspan="1"/>

						<#-- Допускается ввод только цифровых символов. Корректный номер состоит из 15-ти символов.  Валидатор - ОГРНИП-->
                        <@sf.textfield  path="form.ogrn" qtip="" validation="ogrnind required" style="text-align:left;" colspan="25"/>
                ...
                <@sf.fldrow>
						...
						<#-- Формат: "xxxxxxxxxxxx", где x = 0..9. Иными словами, 12 цифр.-->
                        <@sf.label title="ИНН:" required=true style="text-align:left;" colspan="11"/>

						<@sf.empty colspan="1"/>

						<#-- Формат: "xxxxxxxxxxxx", где x = 0..9. Иными словами, 12 цифр.-->
                        <@sf.textfield  path="form.inn" qtip="" validation="innind required" style="text-align:left;" colspan="25"/>
                ...
                <@sf.fldrow>
						...
						<@sf.statictext style="text-align:left;" colspan="50"><h2>Данные документа, подтверждающего факт внесения сведений об индивидуальном предпринимателе в Единый  государственный реестр индивидуальных предпринимателей </h2></@sf.statictext>
                ...
                <@sf.fldrow>
						...
						<#-- валидатор серия-номер-->
                        <@sf.label title="Серия и номер бланка:" required=true style="text-align:left;" colspan="11"/>
					
						<@sf.empty colspan="1"/>
					
						<#-- валидатор серия-номер-->
                        <@sf.textfield  path="form.egipser" qtip="Заполняется в формате серия-номер" validation="required licenseSeriaNumberValidator" style="text-align:left;" colspan="25"/>
                ...
                <@sf.fldrow>
						...
						<@sf.textfield  path="form.egipogv" qtip="" validation="required" style="text-align:left;" colspan="25"/>
                ...
                <@sf.fldrow>
						...
						<@sf.label title="Дата выдачи:" required=true style="text-align:left;" colspan="11"/>
					
						<@sf.empty colspan="1"/>
					
						<@sf.datefield path="form.egipdate"  qtip="" validation="required" style="text-align:left;" colspan="25"/>
                ...
                <@sf.fldrow>
						...
						<@sf.label title="Адрес места нахождения органа, осуществившего государственную регистрацию:" required=true style="text-align:left;" colspan="11"/>
					
						<@sf.empty colspan="1"/>
					
						<@sf.textarea path="form.egipadress" qtip="" validation="required" style="text-align:left;" colspan="38"/>
					
                </@sf.fldrow>
				
                <@sf.fldrow>
					
						<@sf.statictext style="text-align:left;" colspan="50"><h2>Данные документа о постановке соискателя лицензии на учет в налоговом органе</h2></@sf.statictext>
                ...
                <@sf.fldrow>
						...
						<#-- валидатор серия-номер-->
                        <@sf.textfield  path="form.regser" qtip="Заполняется в формате серия-номер" validation="required licenseSeriaNumberValidator" style="text-align:left;" colspan="25"/>
                ...
                <@sf.fldrow>
						...
						<@sf.label title="Наименование, код подразделения, выдавшего документ:" required=true style="text-align:left;" colspan="11"/>
					
						<@sf.empty colspan="1"/>
					
						<@sf.textarea path="form.regogv" qtip="" validation="required" style="text-align:left;" colspan="38"/>
                ...
                <@sf.fldrow>
						...
						<@sf.datefield path="form.regdate"  qtip="" validation="required" style="text-align:left;" colspan="25"/>
