...
<#if form.addressSettlementType?has_content || form.addressCity?has_content>
...
<#if form.factAddressSettlementType?has_content || form.factAddressCity?has_content>
...
<#if form.addressPostSettlementDict?has_content || form.addressPostCity?has_content>
...
<#if form.recipientaddressStreetDict?has_content || form.recipientaddressCity?has_content>
...
<#assign formElements = {
    ...
    "grInvalid1":{"widgetClass":"boolean"},
"grInvalid2":{"widgetClass":"boolean"},
"grInvalid3":{"widgetClass":"boolean"},
"childInvalid":{"widgetClass":"boolean"},
