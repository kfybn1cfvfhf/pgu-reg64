...
<@sf.label path="form.dovOpekLoad" title="Документ, подтверждающий факт установления опеки (попечительства):" required=true style="text-align:left;" colspan="48"/>
                ...
                <@sf.fldrow>
						...
						<#-- Валидатор: PDF, DOC, DOCX, XLS, XLSX, JPG, JPEG, PNG, MDI, TIFF, ODT, ODS.-->
<@sf.fileload path="form.dovOpekLoad" qtip="" style="text-align:left;" validation="required" fileExtensions="PDF,DOC,DOCX,XLS,XLSX,JPG,JPEG,PNG,MDI,TIFF,ODT,ODS" colspan="48"/>
...
<br>2. В случае необходимости внести изменения в учетную запись в установленном порядке.</i></@sf.statictext>
                ...
                <@sf.fldrow>
                    ...
                    <@sf.textfield  path="form.lastName" qtip="Допустимо вносить только кириллические буквы, пробел и знак дефиса" validation="required cyrillic" attr="readonly='readonly'" wrapperClass="fieldDisabled" style="text-align:left;" colspan="31"/>
...
<@sf.textfield  path="form.snils" qtip="" validation="required snils" attr="readonly='readonly'" wrapperClass="fieldDisabled" style="text-align:left;" colspan="31"/>
...
<@sf.datefield path="form.birthdate"  qtip="" validation="required" attr="readonly='readonly'" wrapperClass="fieldDisabled" style="text-align:left;" colspan="31"/>
...
<@sf.radiogroup path="form.sex" staticOpts={'1':'Мужской','2':'Женский'} qtip="" colspan="15" mode="horizontal" validation="required"  attr='readonly="true"' wrapperClass='fieldDisabled'/>
