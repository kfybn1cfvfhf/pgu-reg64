...
>
    ...
    <@formFieldAbstract
        radioGroupXFormField="form.death_person_living_settlement_type_gr" radioGroupXLabelTitle="Способ заполнения типа населенного пункта" radioGroupXValidation="required" radioGroupXLabelRequired=true
        dictionaryXFormField="form.death_person_living_settlement_type" dictionaryXLabelTitle="Тип населенного пункта" dictionaryXDicCode="SETTELEMENT_TYPE_LS" dictionaryXValidation="required" dictionaryXLabelRequired=true
        textboxXFormField="death_person_living_settlement_type_m" textboxXLabelTitle="Тип населенного пункта" textboxXValidation="maxlength regexp required" textboxXValidationAttr={'maxlength':20, 'regexp':'/^[ЁёА-Яа-я0-9\\s./-]{0,200}$/', "message":"Допустим ввод кириллицы, цифр и символов -/."} textboxXLabelRequired=true
...
>
    <@textboxAbstract
    textboxXFormField="form.death_person_living_settlement_type_m" textboxXLabelTitle="Тип населенного пункта" textboxXValidation="maxlength regexp required" textboxXValidationAttr={'maxlength':20, 'regexp':'/^[ЁёА-Яа-я0-9\\s./-]{0,200}$/', "message":"Допустим ввод кириллицы, цифр и символов -/."} textboxXLabelRequired=true
    textboxLabelColspanPaddingLeft=textboxLabelColspanPaddingLeft textboxLabelColspan=textboxLabelColspan textboxFieldColspan=textboxFieldColspan textboxFieldColspanPaddingRight=textboxFieldColspanPaddingRight textboxSeparatorColspan=textboxSeparatorColspan
    notd=notd nolabel=nolabel nofield=nofield noseparator=noseparator
    />
</#macro>
...
<#macro switchableNasPun>
    ...
    radioGroupXFormField=form.death_person_living_settlement_type_gr!''
    dictionaryXFormField=form.death_person_living_settlement_type!''
    dictionaryXDicCode="SETTELEMENT_TYPE_LS"
    textboxXFormField=form.death_person_birth_settlement_type_m!''
    settelement=form.death_person_living_settlement!''
    />
</#macro>

<#macro onReady scope="ROW">
    <@onReadyAbstract dictionaryXFormField="death_person_living_settlement_type" scope=scope />
</#macro>
