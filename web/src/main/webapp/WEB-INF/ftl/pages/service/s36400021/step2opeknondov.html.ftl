...
<@sf.datefield path="form.birthdate"  qtip="" validation="required" attr='readonly="readonly"' wrapperClass='fieldDisabled' style="text-align:left;" colspan="7"/>
						<@sf.empty colspan="24"/>
...
Могут быть изменены в ходе заполнения формы заявления.</i></@sf.statictext>
                ...
                <@sf.fldrow>
						...
						<@sf.statictext style="text-align:left;" colspan="48"><h2>Контакты  законного представителя</h2></@sf.statictext>
...
<@sf.statictext style="text-align:left;" colspan="48"><h2>Сведения о месте регистрации законного представителя</h2></@sf.statictext>
...
<@sf.statictext style="text-align:left;" colspan="48"><h2>Сведения о почтовом адресе законного представителя</h2></@sf.statictext>
                ...
                <@sf.fldrow>
						...
						<@sf.statictext style="text-align:left;" colspan="48"><h2>Сведения о документе, удостоверяющем личность законного представителя</h2></@sf.statictext>
