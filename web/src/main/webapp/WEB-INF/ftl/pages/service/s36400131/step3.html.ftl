...
<@sf.textfield  path="form.inn" qtip="Вносится в формате: XXXXXXXXXXXXX, где X – одна обязательная цифра (12 цифр)" validation="digitsexact" validationattr={'digitsexact':12} style="text-align:left;" colspan="31"/>
                </@sf.fldrow>
...
<@sf.textfield  path="form.ogrnip" qtip="Вносится в формате: XXXXXXXXXXXXXXX, где X – одна обязательная цифра (15 цифр)" validation="digitsexact required" validationattr={'digitsexact':15} style="text-align:left;" colspan="31"/>
                </@sf.fldrow>
