        ...
        <@sf.serviceForm>
            ...
            <@sf.serviceStepForm withFileUpload=true includeEmptyTr=true>
                ...
                <@sf.fldrow>
                    ...
                    <@sf.textfield path="form.identityDocType" qtip="" attr='readonly="readonly"' wrapperClass='fieldDisabled' validation="required" style="text-align:left;" colspan="31"/>
                </@sf.fldrow>
                ...
                <@sf.fldrow>
                    <@sf.fileload path="form.identityDocLoad" validation="required" fileExtensions="PDF,DOC,DOCX,XLS,XLSX,JPG,JPEG,PNG,MDI,TIFF,ODT,ODS" qtip="Копия страниц паспорта № 2, 3, 5." style="text-align:left;" colspan="48"/>
                </@sf.fldrow>
