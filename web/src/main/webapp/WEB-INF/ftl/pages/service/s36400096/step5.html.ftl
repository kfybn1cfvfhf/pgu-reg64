...
<@html.html>
    <@html.head title='Выдача решения о переводе или об отказе в переводе жилого помещения в нежилое или нежилого помещения в жилое помещение'>
        <@script.scripttag>
            <@jquery.onready>
                <@action.cloneFormRowWithArrays clonesectionclass='decisionDocLoadClass' hideButtonSections='true'/>
...
<@sf.fileload path="form.proectDocLoad" fileExtensions="PDF,DOC,DOCX,XLS,XLSX,JPG,JPEG,PNG,MDI,TIFF,ODT,ODS" qtip="Предоставляется в случае, если переустройство и (или) перепланировка требуется для обеспечения использования такого помещения в качестве жилого или нежилого помещения" style="text-align:left;" colspan="48"/>
                ...
                <@sf.fldrow>
<@sf.label path="form.decisionDocLoad" title="Решение о переводе помещения, принятое уполномоченным органом юридического лица:" required=true style="text-align:left;" colspan="48"/>
                </@sf.fldrow>


                <@sf.initAllClones formElement=form.decisionDocLoad cloneSectionClass='decisionDocLoadClass' ; k>
                    <@sf.fldrow class="decisionDocLoadClass">
                        <@sf.fileload path="form.decisionDocLoad[${k}]" fileExtensions="PDF,DOC,DOCX,XLS,XLSX,JPG,JPEG,PNG,MDI,TIFF,ODT,ODS" validation="required" qtip="<br>Предоставляется в случае, если собственником переводимого помещения является юридическое лицо" style="text-align:left;" colspan="48"/>
                    </@sf.fldrow>
                    <@sf.fldrow class="decisionDocLoadClass">
