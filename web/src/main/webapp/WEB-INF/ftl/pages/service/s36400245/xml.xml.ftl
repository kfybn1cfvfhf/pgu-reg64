...
<SOAP-ENV:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:SOAP-ENV="http://schemas.xmlsoap.org/soap/envelope/" xmlns:wss="http://wss.variant-sm.ru">
   <SOAP-ENV:Header/>
   <SOAP-ENV:Body>
      <mns:GetTempWorks xmlns:mns="http://wss.variant-sm.ru" SOAP-ENV:encodingStyle="http://schemas.xmlsoap.org/soap/encoding/">
        <request xsi:type="tns:dt_tempworkq">
                ...
                <#if form.unprotected?has_content>
                <#assign seq = form.unprotected?split("\\D+", 'r')>
                <#assign full = 0>
                <#list seq as work>
                    <#if work != ''>
                        <#assign s = work?number>
                            <#if work_has_next>
                                <#assign full=full+s>
                            <#else>
                                <#assign full=full+s>
                ...
                <unprotected xsi:type="xsd:string">${full}</unprotected>
