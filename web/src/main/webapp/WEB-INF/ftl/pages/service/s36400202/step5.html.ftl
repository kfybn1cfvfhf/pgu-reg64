	...
	<@html.sitenavigator step=3/>
        <@sf.serviceForm>
            ...
            <@sf.serviceStepForm  includeEmptyTr=true>
                ...
                <@sf.fldrow>
                        <@sf.label path="form.addressBenefit" title="Почтовый адрес по которому будет осуществлятся доставка пособия:" required=true style="text-align:left;" colspan="17"/>
