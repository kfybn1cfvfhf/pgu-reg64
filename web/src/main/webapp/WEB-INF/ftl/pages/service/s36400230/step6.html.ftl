    ...
    <@html.head title='Подача электронной заявки на повторную выдачу свидетельства о браке'>
        <@script.scripttag>
            ...
            <@jquery.onready>
                ...
                <@commonValidation.clearValidationMessageOnChange ['addr_agency_street_type'], ['addr_agency_street'] />-->
        ...
        <@sf.serviceForm>
            ...
            <@sf.serviceStepForm>
                ...
                <@sf.fldrow>
						...
						<@sf.empty colspan="1"/>
						<@sf.textfield  path="form.addr_agency" qtip="" validation="regexp maxlength" attr='maxlength="200"' validationattr={'maxlength':'200', 'regexp':'/^[\\|\\"ЁёА-Яа-я0-9\\s.,/№()-]{0,200}$/'} validationMessage={"regexp":"Допустим ввод кириллицы, цифр и символов \"№(-)/|,."} style="text-align:left;" colspan="29"/>
					    <@sf.empty colspan="11"/>
                </@sf.fldrow>
                ...
                <@sf.fldrow>
                    ...
                    <@sf.empty colspan="1"/>
                    <@sf.dictionaryLookup  path="form.addr_agency_country" qtip="" validation="maxlength" validationattr={'maxlength':'200'}  dictionaryCode="COUNTRY_LS" style="text-align:left;" colspan="29"/>
                    <@sf.empty colspan="11"/>
                </@sf.fldrow>
                ...
                <@sf.fldrow>
						...
						<@sf.empty colspan="1"/>
						<@sf.textfield  path="form.addr_agency_state" qtip="" validation="regexp maxlength" attr='maxlength="200"' validationattr={'maxlength':'80', 'regexp':'/^[ЁёА-Яа-я\\s()-]{0,200}$/'}  validationMessage={"regexp":"Допустим ввод кириллицы, символов (-)"} style="text-align:left;" colspan="29"/>
					    <@sf.empty colspan="11"/>
                </@sf.fldrow>
                ...
                <@sf.fldrow>
                        ...
                        <@sf.empty colspan="1"/>
						<@sf.textfield  path="form.addr_agency_region" qtip="" validation="regexp maxlength" attr='maxlength="200"' validationattr={'maxlength':'80', 'regexp':'/^[ЁёА-Яа-я\\s()-]{0,200}$/'}  validationMessage={"regexp":"Допустим ввод кириллицы, символов (-)"} style="text-align:left;" colspan="29"/>
					    <@sf.empty colspan="11"/>
                </@sf.fldrow>
                ...
                <@sf.fldrow>
						...
						<@sf.empty colspan="1"/>
						<@sf.textfield  path="form.addr_agency_settlement" qtip="" validation="regexp maxlength" attr='maxlength="200"'  validationattr={'maxlength':'80', 'regexp':'/^[\\|\\"ЁёА-Яа-я0-9\\s./№()-]{0,200}$/'}  validationMessage={"regexp":"Допустим ввод кириллицы, цифр и символов \"№(-)./|"} style="text-align:left;" colspan="29"/>
					    <@sf.empty colspan="11"/>
                </@sf.fldrow>
                ...
                <@sf.fldrow>
						...
						<@sf.empty colspan="1"/>
						<@sf.textfield  path="form.addr_agency_street" qtip="" validation="regexp required maxlength" attr='maxlength="200"' validationattr={'maxlength':'33', 'regexp':'/^[\\|\\"ЁёА-Яа-я0-9\\s./№()-]*$/'}  validationMessage={"regexp":"Допустим ввод кириллицы, цифр и символов \"№(-)/|."} style="text-align:left;" colspan="29"/>
					    <@sf.empty colspan="11"/>
                </@sf.fldrow>
                ...
                <@sf.fldrow>
						...
						<@sf.empty colspan="1"/>
						<@sf.textfield  path="form.addr_agency_house" qtip=""  validation="maxlength" validationattr={"maxlength":7} attr='maxlength="10"'  style="text-align:left;" colspan="6"/>
						<@sf.empty colspan="2"/>
						<@sf.label path="form.addr_agency_building" title="Корпус" required=false style="text-align:right;" colspan="9"/>
						<@sf.empty colspan="1"/>
						<@sf.textfield  path="form.addr_agency_building" qtip="" validation="maxlength" validationattr={"maxlength":4} attr='maxlength="10"'  style="text-align:left;" colspan="10"/>
						<@sf.empty colspan="12"/>
                </@sf.fldrow>-->
