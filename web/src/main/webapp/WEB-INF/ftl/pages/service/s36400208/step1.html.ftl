        ...
        <@sf.serviceForm>
            ...
            <@sf.serviceStepForm  includeEmptyTr=true>
                ...
                <@sf.fldrow>
                    ...
                    <@sf.label path="form.ip_enable" title="Заявитель зарегистрирован в качестве индивидуального предпринимателя:" required=false style="text-align:left;" colspan="17"/>
