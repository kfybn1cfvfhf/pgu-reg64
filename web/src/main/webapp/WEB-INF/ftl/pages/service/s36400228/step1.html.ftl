        ...
        <@sf.serviceForm>
            ...
            <@sf.serviceStepForm>
                ...
                <@sf.fldrow>
                    ...
                    <@sf.empty colspan="1"/>
                    <@sf.staticLookup path="form.doc_type" staticData={"SVIDET":"Повторное свидетельство","SPRAVKA":"Справка"} validation="required" qtip="" style="text-align:left;" colspan="35"/>
                    <@sf.empty colspan="1"/>
                </@sf.fldrow>
                ...
                <@sf.fldrow>
					...
					<@sf.empty colspan="1"/>
					<#-- lookup Запрос к веб-сервису списка ЗАГСов-->
                    <@sf.customLookup  path="form.id_agency_in" controller='Nahodka_Zagses' optionsMap=clu.createOptionsMap(form, {"userSelectedRegion":"${userSelectedRegion!''}","getExtZagsesByGroup": "AZ_POVT"}) resultCallbacks=['setZagsDetailsInfo'] qtip="" validation="required" style="text-align:left;" colspan="35"/>
                    <@sf.empty colspan="1"/>
                </@sf.fldrow>
