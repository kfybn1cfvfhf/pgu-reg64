...
<br>2. В случае необходимости внести изменения в учетную запись в установленном порядке.</i></@sf.statictext>
                ...
                <@sf.fldrow>
                    ...
                    <@sf.textfield  path="form.warrantPlace" qtip="" validation="required" style="text-align:left;" colspan="31"/>
                </@sf.fldrow>
                ...
                <@sf.fldrow>
                    ...
                    <@sf.datefield path="form.warrantDate"  qtip="" validation="required" style="text-align:left;" colspan="31"/>
                ...
                <@sf.fldrow>
                    ...
                    <@sf.textfield  path="form.warrantSeria" qtip="" validation="required" style="text-align:left;" colspan="31"/>
                ...
                <@sf.fldrow>
                    ...
                    <@sf.textfield  path="form.warrantNo" qtip="" validation="required" style="text-align:left;" colspan="31"/>
