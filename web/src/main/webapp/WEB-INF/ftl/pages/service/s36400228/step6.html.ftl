        ...
        <@sf.serviceForm>
            ...
            <@sf.serviceStepForm>
                ...
                <@sf.fldrow>
						...
						<@sf.empty colspan="1"/>
						<@sf.textfield  path="form.addr_agency_state" qtip="" validation="regexp maxlength" attr='maxlength="80"' validationattr={'maxlength':'80', 'regexp':'/^[ЁёА-Яа-я\\s()-]{0,200}$/'}  validationMessage={"regexp":"Допустим ввод кириллицы, символов (-)"} style="text-align:left;" colspan="29"/>
					    <@sf.empty colspan="11"/>
                </@sf.fldrow>
                ...
                <@sf.fldrow>
                        ...
                        <@sf.empty colspan="1"/>
						<@sf.textfield  path="form.addr_agency_region" qtip="" validation="regexp maxlength" attr='maxlength="80"' validationattr={'maxlength':'80', 'regexp':'/^[ЁёА-Яа-я\\s()-]{0,200}$/'}  validationMessage={"regexp":"Допустим ввод кириллицы, символов (-)"} style="text-align:left;" colspan="29"/>
					    <@sf.empty colspan="11"/>
                </@sf.fldrow>-->
                ...
                <@sf.fldrow>
						...
						<@sf.empty colspan="1"/>
						<@sf.textfield  path="form.addr_agency_settlement" qtip="" validation="regexp maxlength" attr='maxlength="80"'  validationattr={'maxlength':'80', 'regexp':'/^[\\|\\"ЁёА-Яа-я0-9\\s./№()-]{0,200}$/'}  validationMessage={"regexp":"Допустим ввод кириллицы, цифр и символов \"№(-)./|"} style="text-align:left;" colspan="29"/>
					    <@sf.empty colspan="11"/>
                </@sf.fldrow>
                ...
                <@sf.fldrow>
						...
						<@sf.empty colspan="1"/>
						<@sf.textfield  path="form.addr_agency_street" qtip="" validation="regexp required maxlength" attr='maxlength="33"' validationattr={'maxlength':'33', 'regexp':'/^[\\|\\"ЁёА-Яа-я0-9\\s./№()-]{0,200}$/'}  validationMessage={"regexp":"Допустим ввод кириллицы, цифр и символов \"№(-)/|."} style="text-align:left;" colspan="29"/>
					    <@sf.empty colspan="11"/>
                </@sf.fldrow>
                ...
                <@sf.fldrow>
						...
						<@sf.empty colspan="1"/>
						<@sf.textfield  path="form.addr_agency_house" qtip=""  validation="maxlength" attr='maxlength="7"'  validationattr={'maxlength':'7'} style="text-align:left;" colspan="6"/>
						<@sf.empty colspan="2"/>
						<@sf.label path="form.addr_agency_building" title="Корпус" required=false style="text-align:right;" colspan="9"/>
						<@sf.empty colspan="1"/>
						<@sf.textfield  path="form.addr_agency_building" qtip="" validation="maxlength" attr='maxlength="4"' validationattr={'maxlength':'4'}  style="text-align:left;" colspan="10"/>
						<@sf.empty colspan="12"/>
                </@sf.fldrow>
-->
                <@sf.fldrow>
