    ...
    <@html.body>
        ...
        <@sf.serviceForm>
            ...
            <@sf.serviceStepForm withFileUpload=true includeEmptyTr=true>
                ...
                <@sf.statictext style="text-align:left;" colspan="48"><h2>Сведения о контактной информации
                    организации</h2></@sf.statictext>
                ...
                <@sf.statictext style="text-align:left;" colspan="48"><h2>Сведения о руководителе
                    организации</h2></@sf.statictext>
