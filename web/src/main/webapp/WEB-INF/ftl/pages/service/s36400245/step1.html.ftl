        ...
        <@sf.serviceForm>
            ...
            <@sf.serviceStepForm  includeEmptyTr=true>
                ...
                <@sf.fldrow>
                        ...
                        <@sf.label path="form.last_name" title="Фамилия:" required=true style="text-align:right;" colspan="11"/>
                ...
                <@sf.fldrow>
						...
						<#-- Недоступно для редактирования. Данные из СИА.-->
                        <@sf.label path="form.first_name" title="Имя:" required=true style="text-align:right;" colspan="11"/>
                ...
                <@sf.fldrow>
						...
						<#-- Недоступно для редактирования. Данные из СИА.-->
                        <@sf.label path="form.middle_name" title="Отчество:" required=false style="text-align:right;" colspan="11"/>

						<@sf.empty colspan="1"/>

						<#-- Недоступно для редактирования. Данные из СИА.-->
                        <@sf.textfield  path="form.middle_name" validation="maxlength"
                            validationattr={"maxlength":500} attr="maxlength='500'" qtip="" style="text-align:left;" colspan="34"/>
                ...
                <@sf.fldrow>
						...
						<#-- Недоступно для редактирования. Данные из СИА.-->
                        <@sf.label path="form.birth_date" title="Дата рождения:" required=true style="text-align:right;" colspan="11"/>
                ...
                <@sf.fldrow>
						...
						<#-- Недоступно для редактирования. Данные из СИА.-->
                        <@sf.label path="form.sex" title="Пол:" required=true style="text-align:right;" colspan="11"/>
                ...
                <@sf.fldrow>
						...
						<@sf.label path="form.citizenship" title="Гражданство:" required=true style="text-align:right;" colspan="11"/>
                ...
                <@sf.fldrow>
                        ...
                        <@sf.label path="form.unprotected" title="Категория испытывающих<br>трудности в поиске работы:" required=true style="text-align:right;" colspan="11"/>
                        <@sf.empty colspan="1"/>

                        <@sf.checkboxLookup path="form.unprotected" dictionaryCode="VARIANT_UNPROTECTED_LS" qtip="" validation="required" style="text-align:left;" colspan="34"/>
                ...
                <@sf.fldrow>
						...
						<#-- Недоступно для редактирования. Данные из СИА.-->
                        <@sf.label path="form.passport_type" title="Тип документа:" required=false style="text-align:right;" colspan="11"/>

						<@sf.empty colspan="1"/>

						<#-- Недоступно для редактирования. Данные из СИА.-->
                        <@sf.textfield  path="form.passport_type" qtip=""  style="text-align:left;" colspan="34"/>
                ...
                <@sf.fldrow>
						...
						<#-- Недоступно для редактирования. Данные из СИА.-->
                        <@sf.label path="form.passport_series" title="Серия:" required=false style="text-align:right;" colspan="11"/>

						<@sf.empty colspan="1"/>

						<#-- Недоступно для редактирования. Данные из СИА.-->
                        <@sf.textfield  path="form.passport_series" qtip=""  style="text-align:left;" colspan="12"/>
                ...
                <@sf.fldrow>
						...
						<#-- Недоступно для редактирования. Данные из СИА.-->
                        <@sf.label path="form.passport_number" title="Номер:" required=false style="text-align:right;" colspan="11"/>

						<@sf.empty colspan="1"/>

						<#-- Недоступно для редактирования. Данные из СИА.-->
                        <@sf.textfield  path="form.passport_number" qtip=""  style="text-align:left;" colspan="12"/>
                ...
                <@sf.fldrow>
						...
						<#-- Недоступно для редактирования. Данные из СИА.-->
                        <@sf.label path="form.passport_given_out" title="Кем выдан:" required=false style="text-align:right;" colspan="11"/>

						<@sf.empty colspan="1"/>

						<#-- Недоступно для редактирования. Данные из СИА.-->
                        <@sf.textfield  path="form.passport_given_out" qtip=""  style="text-align:left;" colspan="34"/>
                ...
                <@sf.fldrow>
						...
						<#-- Недоступно для редактирования. Данные из СИА.-->
                        <@sf.label path="form.passport_delivery_date" title="Дата выдачи:" required=false style="text-align:right;" colspan="11"/>
                ...
                <@sf.fldrow>
						...
						<@sf.label path="form.addr_Index" title="Почтовый индекс:" required=false style="text-align:right;" colspan="11"/>
                ...
                <@sf.fldrow>
                        ...
                        <@sf.label path="form.addr_obl" title="Город/Населенный пункт:" required=true style="text-align:right;" colspan="11"/>
                ...
                <@sf.fldrow>
                        ...
                        <@sf.label path="form.addr_ul" title="Улица:" required=false style="text-align:right;" colspan="11"/>

						<@sf.empty colspan="1"/>

						<#-- Выбирается из справочника КЛАДР в соответствии с Городом/Населенным пунктом-->
                        <@sf.dictionaryLookup path="form.addr_ul" dictionaryCode="KLADRStreet" qtip="" title="Улица" dependsOn=[{'fieldId': 'addr_obl'}] parentLookup={'fieldId': 'addr_obl', 'dependency': 'LookupWidget.dependency["КЛАДР:Населённый-пункт"]'} style="text-align:left;" colspan="34"/>
                ...
                <@sf.fldrow>
						...
						<@sf.label path="form.addr_dom" title="Дом:" required=false style="text-align:right;" colspan="11"/>

						<@sf.empty colspan="1"/>

						<@sf.textfield  path="form.addr_dom" qtip="" validation="maxlength"
                            validationattr={"maxlength":500} attr="maxlength='500'" style="text-align:left;" colspan="7"/>
                ...
                <@sf.fldrow>
						...
						<@sf.label path="form.tel" title="Контактный телефон:" required=false style="text-align:right;" colspan="11"/>
                ...
                <@sf.fldrow>
                        ...
                        <@sf.label path="form.mail" title="Адрес электронной почты:" required=false style="text-align:right;" colspan="11"/>
