...
<@html.html>
    <@html.head title='Учет граждан, обратившихся за предоставлением жилого помещения по договору социального найма из государственного жилищного фонда области'>
        <@script.scripttag>
            <@jquery.onready>
                <@action.setVisibleByValue onload="true"  srcid="incapable_enable" event="change" value="on" destid="dovCategory" scope="LBL+EL+ROW"/>
                <@action.unsetDisabledByValue onload="true" srcid="incapable_enable" event="change" value="on" destid="dovCategory"  />
	...
	<@html.sitenavigator step=3/>
        <@sf.serviceForm>
            ...
            <@sf.serviceStepForm  includeEmptyTr=true>
                ...
                <@sf.fldrow>
                    <@sf.label path="form.lonelyCh" title="Получатель услуги является одиноким гражданином:" required=false style="text-align:left;" colspan="18"/>
                    <@sf.checkbox path="form.lonelyCh" qtip=""  style="text-align:left;" colspan="1"/>
                    <@sf.empty colspan="29"/>
...
В этом случае необходимо:
1. Внести в соответствующие поля сведения о заявителе
2. На шаге, предназначенном для представления вместе с заявлением электронных документов приложить документ, удостоверяющий личность законного представителя и документ, подтверждающий право законного представителя."  style="text-align:left;" colspan="30"/>
                </@sf.fldrow>
