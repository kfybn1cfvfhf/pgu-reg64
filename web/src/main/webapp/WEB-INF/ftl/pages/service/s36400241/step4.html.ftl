        ...
        <@sf.serviceForm>
            ...
            <@sf.serviceStepForm  includeEmptyTr=true>
                ...
                <@sf.fldrow>
						...
						<@sf.statictext style="text-align:left;" colspan="48"><h2>Сведения о способе начисления ежегодной денежной выплаты</h2></@sf.statictext>
...
<@sf.dictionaryLookup path="form.wayBenefit" dictionaryCode="03_METHOD_DELIVERY_BENEFIT_64" qtip="" validation="required" style="text-align:left;" colspan="31"/>
                ...
                <@sf.fldrow>
<@sf.label path="form.addressBenefit" title="Номер почтового отделения, на которое будет осуществляться перечисление выплаты:" required=true style="text-align:left;" colspan="17"/>
