        ...
        <@sf.serviceForm>
            ...
            <@sf.serviceStepForm  includeEmptyTr=true>
                ...
                <@sf.fldrow>
						...
						<@sf.dictionaryLookup path="form.obr_type" dictionaryCode="VARIANT_EDUCATION_LS" qtip=""  validation="required" style="text-align:left;" colspan="31"/>
                ...
                <@sf.fldrow>
                        ...
                        <@sf.textfield  path="form.institution" qtip="" validation="maxlength"
                            validationattr={"maxlength":500} attr="maxlength='500'"  style="text-align:left;" colspan="31"/>
                ...
                <@sf.fldrow>
					    ...
					    <@sf.empty colspan="1"/>
                        <@sf.dictionaryLookup path="form.speciality_diploma" dictionaryCode="VARIANT_OKPDTR_LS" qtip=""  validation="" style="text-align:left;" colspan="31"/>
				...
				<#--<@sf.fldrow class="clonesectionAddNewObj clone-buttons-section">-->
                        <#--<@sf.empty colspan="42"/>-->
                        <#--<@sf.addRemoveButton addTitle='Добавить' delTitle='Удалить' colspan="5"/>-->
                        <#--<@sf.empty colspan="1"/>-->
                <#--</@sf.fldrow>-->
				<#--</@sf.initAllClones>-->
                <@sf.fldrow>
                ...
                <@sf.fldrow>
						...
						<@sf.dictionaryLookup path="form.employment" dictionaryCode="VARIANT_EMPLOYMENT_LS" qtip="" validation="required" style="text-align:left;" colspan="31"/>
...
Выбирается из справочника КЛАДР в соответствии с Регионом/Областью-->
                        ...
                        <@sf.dictionaryLookup path="form.addr_raion_info" dictionaryCode="VARIANT_TRANCHE_LS"  title="Район"  terminalLevel="2" qtip="" validation="required" style="text-align:left;" colspan="31"/>
