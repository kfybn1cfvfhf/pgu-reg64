...
<@sf.label path="form.dovPasLoad" title="Документ, удостоверяющий личность уполномоченного представителя:" required=true style="text-align:left;" colspan="48"/>
						...
						<#-- Валидатор: PDF, DOC, DOCX, XLS, XLSX, JPG, JPEG, PNG, MDI, TIFF, ODT, ODS.-->
                        <@sf.fileload path="form.dovPasLoad" validation="required" fileExtensions="PDF,DOC,DOCX,XLS,XLSX,JPG,JPEG,PNG,MDI,TIFF,ODT,ODS" qtip="Прикладываются сканированные страницы документа, содержащие Ф.И.О., фото, место жительства" style="text-align:left;" colspan="48"/>
                </@sf.fldrow>
...
2. Отображается при выборе значения "2. Отцом"
3. Не отображается при выборе значения "3. Опекуном (попечителем)"-->
<@sf.textarea path="form.placeJob" qtip="" validation="required" style="text-align:left;" colspan="31"/>
...
<@sf.label path="form.identityDocLoad" title="Документ, удостоверяющий личность заявителя:" required=true style="text-align:left;" colspan="48"/>
                ...
                <@sf.fldrow>
						...
						<#-- Валидатор: PDF, DOC, DOCX, XLS, XLSX, JPG, JPEG, PNG, MDI, TIFF, ODT, ODS.-->
                        <@sf.fileload path="form.identityDocLoad" validation="required" fileExtensions="PDF,DOC,DOCX,XLS,XLSX,JPG,JPEG,PNG,MDI,TIFF,ODT,ODS" qtip="Прикладываются сканированные страницы документа, содержащие Ф.И.О., фото, место жительства" style="text-align:left;" colspan="48"/>
