...
Могут быть изменены в ходе заполнения формы заявления.</i></@sf.statictext>
                ...
                <@sf.fldrow>
						...
						<#-- блок: residenceAdress-->
<@sf.statictext style="text-align:left;" colspan="48"><h2>Сведения о месте жительства заявителя</h2></@sf.statictext>
					
                </@sf.fldrow>

                <@address.block_country_form fieldsMap=fieldsMap country='residenceAdressCountry' countryCode='residenceAdressCountryCode' input='residenceAdressEnterType' country_input='residenceAdressCountryInput'
