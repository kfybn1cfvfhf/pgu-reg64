    ...
    <@html.body>
        ...
        <@sf.serviceForm>
            ...
            <@sf.serviceStepForm withFileUpload=true includeEmptyTr=true>
                ...
                <@sf.fldrow>
                    <@sf.label path="form.docMvRegIPLoad" title="Документ, подтверждающий государственную регистрацию в качестве индивидуального предпринимателя:" required=false style="text-align:left;" colspan="48"/>
                </@sf.fldrow>
