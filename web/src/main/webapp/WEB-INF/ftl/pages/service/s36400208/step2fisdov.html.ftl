    ...
    <@html.body>
        ...
        <@sf.serviceForm>
            ...
            <@sf.serviceStepForm withFileUpload=true includeEmptyTr=true>
                ...
                <@sf.fldrow><@sf.statictext style="text-align:left;" colspan="48"><h2>Сведения о
                    заявителе</h2></@sf.statictext></@sf.fldrow>
                ...
                <@sf.fldrow><@sf.statictext style="text-align:left;" colspan="48"><h2>Почтовый адрес заявителя</h2></@sf.statictext></@sf.fldrow>
