        ...
        <@sf.serviceForm>
            ...
            <@sf.serviceStepForm  >
                ...
                <@sf.fldrow>
						...
						<@sf.datefield path="form.lic_date_st"  qtip="" validation="required" style="text-align:left;" colspan="8"/>
                        <@sf.empty colspan="17"/>
                ...
                <@sf.fldrow>
						...
						<@sf.label title="Данные документа (вид, название, дата издания и номер), являющегося основанием для переоформления документа, подтверждающего наличие лицензии:" style="text-align:left;" colspan="45"/>

						</@sf.fldrow>

                <@sf.fldrow>
                         <@sf.empty colspan="2"/>
						<@sf.textarea path="form.lic_basic" qtip="" style="text-align:left;" colspan="45"/>
