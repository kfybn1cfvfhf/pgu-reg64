...
<@html.html>
    <@html.head title='Выдача дубликата лицензии/копии лицензии на осуществление медицинской деятельности'>
        <@script.scripttag>
            <@jquery.onready>
        ...
        <@sf.serviceForm>
            ...
            <@sf.serviceStepForm withFileUpload=true >
                ...
                <@sf.fldrow>
						...
						<#-- данные СИА-->
                        <@sf.label title="Фамилия, имя, отчество (если имеется) лицензиата:" required=true style="text-align:left;" colspan="11" />
					
						<@sf.empty colspan="1"/>
					
						<#-- данные СИА-->
                        <@sf.textfield  path="form.declarant_name" qtip="" validation="required" style="text-align:left;" colspan="34" attr='readonly="readonly"' wrapperClass='fieldDisabled'/>
                ...
                <@sf.fldrow>
						...
						<@sf.label title="Копия свидетельства о постановке на учет в налоговом органе физического лица по месту жительства на территории Российской Федерации:" required=false style="text-align:left;" colspan="11"/>
					
						<@sf.empty colspan="1"/>
					
						<@sf.fileload  path="form.inn" fileExtensions="pdf,doc,jpg" qtip=""  style="text-align:left;" colspan="11"/>
                ...
                <@sf.fldrow>
						...
						<#-- Валидатор ОГРНИП-->
                        <@sf.fileload  path="form.ogrnip" fileExtensions="pdf,doc,jpg" qtip="" validation="required" style="text-align:left;" colspan="11"/>
