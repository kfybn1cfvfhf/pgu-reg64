...
<#import "/pages/service/fieldblocks/np/ronameblock.ftl" as ronameblock>
...
2. В случае необходимости внести изменения в учетную запись в установленном порядке.</i></@sf.statictext>
                    ...
                    <@ronameblock.renderReadOnlyNameFieldBlock />

                <@sf.fldrow>

                    <@sf.statictext style="text-align:left;" colspan="48"><i>Поля «Контактный телефон», «Адрес электронной почты» заполняются на основании учетной записи на портале. Могут быть изменены в ходе заполнения формы заявления</i></@sf.statictext>
