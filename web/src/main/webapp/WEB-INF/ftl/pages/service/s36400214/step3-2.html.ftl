...
<@sf.label path="form.identityDocLoad" title="Документ, удостоверяющий личность заявителя:" required=false style="text-align:left;" colspan="48"/>
                ...
                <@sf.fldrow>
						...
						<#-- Валидатор: PDF, DOC, DOCX, XLS, XLSX, JPG, JPEG, PNG, MDI, TIFF, ODT, ODS.-->
<@sf.fileload path="form.identityDocLoad" fileExtensions="PDF,DOC,DOCX,XLS,XLSX,JPG,JPEG,PNG,MDI,TIFF,ODT,ODS" qtip="Предоставляется по желанию заявителя" style="text-align:left;" colspan="48"/>
