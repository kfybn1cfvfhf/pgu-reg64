      ...
      <wss:putZjvRB10>
         <zjv>
            ...
            <he>
               ...
               <docum>
                  <nam><#if form.he_doc_type?has_content>${dicRegistry.getItemByKey('DUL_LS', form.he_doc_type).name}</#if></nam>
                  <seria>${form.he_doc_ser!''}</seria>
                  <num>${form.he_doc_number!''}</num>

                  <dat>
                      <#if form.he_doc_date?has_content>
                          <dtDay>${form.he_doc_date?string("dd")}</dtDay>
                          <dtMonth>${form.he_doc_date?string("MM")}</dtMonth>
                          <dtYear>${form.he_doc_date?string("yyyy")}</dtYear>
                      <#else>
                          <dtDay/>
                          <dtMonth/>
                          <dtYear/>
               ...
               <mestoLive>
                  ...
                  <@opttag "form.he_living_flat " "kvart"/>

                  <indMal></indMal>
               </mestoLive>

                <datRojd>
                    <#if form.he_birth_date?has_content>
                        <dtDay>${form.he_birth_date?string("dd")}</dtDay>
                        <dtMonth>${form.he_birth_date?string("MM")}</dtMonth>
                        <dtYear>${form.he_birth_date?string("yyyy")}</dtYear>
                    <#else>
                        <dtDay/>
                        <dtMonth/>
                        <dtYear/>
            ...
            <she>
               ...
               <docum>
                  ...
                  <num>${form.she_doc_number!''}</num>
                   ...
                   <dat>
                   <#if form.she_doc_date?has_content>
                       <dtDay>${form.she_doc_date?string("dd")}</dtDay>
                       <dtMonth>${form.she_doc_date?string("MM")}</dtMonth>
                       <dtYear>${form.she_doc_date?string("yyyy")}</dtYear>
                   <#else>
                       <dtDay/>
                       <dtMonth/>
                       <dtYear/>
               ...
               <mestoLive>
                ...
                <datRojd>
                    <#if form.she_birth_date?has_content>
                        <dtDay>${form.she_birth_date?string("dd")}</dtDay>
                        <dtMonth>${form.she_birth_date?string("MM")}</dtMonth>
                        <dtYear>${form.she_birth_date?string("yyyy")}</dtYear>
                    <#else>
                        <dtDay/>
                        <dtMonth/>
                        <dtYear/>
            ...
            <reshSud>
               <@opttag "form.name_law" "reshen"/>


               <#if form.decision_law_date?has_content>
                 <datResh>${form.decision_law_date?string('yyyy-MM-dd')}</datResh>
               </#if>
            </reshSud>

            <@opttag "form.declarant" "zjvl"/>
         </zjv>
      </wss:putZjvRB10>
   </soapenv:Body>
</soapenv:Envelope>
