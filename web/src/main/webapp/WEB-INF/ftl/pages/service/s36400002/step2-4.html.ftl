    ...
    <@html.head title='Переоформление лицензии на право ведения образовательной деятельности'>
        <@script.scripttag>
            <@jquery.onready>
                ...
                <@action.cloneFormRowWithArrays clonesectionclass='load_doc29Class' hideButtonSections='true'/>
...
<@sf.fileload path="form.load_doc39" fileExtensions="PDF,DOC,DOCX,XLS,XLSX,JPG,JPEG,PNG,MDI,TIFF,ODT,ODS" validation="required" qtip="" style="text-align:left;" colspan="48"/>
                ...
                <@sf.fldrow>
						...
						<#-- Множественная загрузка
Валидатор: PDF, DOC, DOCX, XLS, XLSX, JPG, JPEG, PNG, MDI, TIFF, ODT, ODS.-->
<@sf.label path="form.load_doc29" title="Копии документов, подтверждающих наличие лицензии, юридических лиц, реорганизованных в форме слияния или присоединения к лицензиату, с приложением (приложениями):" required=false style="text-align:left;" colspan="48"/>
					
                </@sf.fldrow>

                <@sf.initAllClones formElement=form.load_doc28 cloneSectionClass="load_doc29Class" ; x>
                    <@sf.fldrow class="load_doc29Class">
                        <@sf.fileload path="form.load_doc29[${x}]" qtip="" fileExtensions="PDF,DOC,DOCX,XLS,XLSX,JPG,JPEG,PNG,MDI,TIFF,ODT,ODS" style="text-align:left;" colspan="48"/>
                    </@sf.fldrow>
                    <@sf.fldrow class="load_doc29Class">
                        <@sf.addRemoveButton addTitle="Добавить" delTitle="Удалить" colspan="44" />
                    </@sf.fldrow>
