...
<#macro makeSoapRequest
    ...
    formElements                <#-- Хэш вида "<id элемента формы>:<метаданные элемента формы>" -->
    fileloadElements            <#-- Хэш вида "<id элемента загрузки файлов>:<метаданные элемента загрузки файлов>" -->
    applicantAttributes={}      <#-- Хэш вида "<название реквизита заявителя>:<метаданные элемента формы>" -->
>
