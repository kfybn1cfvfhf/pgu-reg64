...
<#import "nakhodka_xml_macros.ftl" as nakhodka>
...
<#macro block_country_form  fieldsMap={} country='' post='' countryCode='' input='' country_input='' settlementRF='' streetRF='' region='' area=''  settlement_type='' country_settlement='' settlement='' city='' street='' house='' corp='' flat='' office=''>
            ...
            <@script.scripttag>
             ...
             <@jquery.onready>
                ...
                <#if office?has_content>
                <@action.setVisibleByValue 'true' '${countryCode}' 'change' '${office}' 'ru,nru' />
                </#if>
...
<#macro block_country_body  fieldsMap={} country='' post='' countryCode='' input='' country_input='' settlementRF='' streetRF='' region='' area='' settlement_type='' country_settlement='' settlement='' city='' street='' house='' corp='' flat='' office=''>
             ...
             <@jquery.onready>
                ...
                <@sf.fldrow>
                <@sf.label path="form.${country}" title="Страна:" required=true style="text-align:left;" colspan=fixFieldsMap["label"]/>
                ...
                <#if post?has_content>
                <@sf.fldrow>
				<@sf.label path="form.${post}" title="Почтовый индекс:" required=false style="text-align:left;" colspan=fixFieldsMap["label"]/>
				<@sf.textfield  path="form.${post}" qtip="" validation="maxlength" validationattr={"maxlength":"10"} style="text-align:left;" colspan=fixFieldsMap["post"]/>
                </@sf.fldrow>
                </#if>

                <@sf.fldrow>
                <@sf.label path="form.${input}" title="Ввод адреса:" required=true style="text-align:left;" colspan=fixFieldsMap["label"]/>
                ...
                <@sf.fldrow>
                <@sf.label path="form.${settlementRF}" title="Населенный пункт:" required=true style="text-align:left;" colspan=fixFieldsMap["label"]/>
              ...
              <#if streetRF?has_content>
                <@sf.fldrow>
                <@sf.label path="form.${streetRF}" title="Улица:" required=false style="text-align:left;" colspan=fixFieldsMap["label"]/>
                ...
                <@sf.fldrow>
				<@sf.label path="form.${region}" title="Область (край, республика):" required=false style="text-align:left;" colspan=fixFieldsMap["label"]/>
                ...
                <@sf.fldrow>
				<@sf.label path="form.${area}" title="Район:" required=false style="text-align:left;" colspan=fixFieldsMap["label"]/>
                ...
                <@sf.fldrow>
                <@sf.label path="form.${settlement_type}" title="Тип населенного пункта:" required=true style="text-align:left;" colspan=fixFieldsMap["label"]/>
                ...
                <@sf.fldrow>
				<@sf.label path="form.${settlement}" title="Населенный пункт:" required=true style="text-align:left;" colspan=fixFieldsMap["label"]/>
                ...
                <@sf.fldrow>
				<@sf.label path="form.${city}" title="Город:" required=true style="text-align:left;" colspan=fixFieldsMap["label"]/>
              ...
              <#if street?has_content>
                <@sf.fldrow>
				<@sf.label path="form.${street}" title="Улица:" required=false style="text-align:left;" colspan=fixFieldsMap["label"]/>
              ...
              <#if house?has_content>
                ...
                <#if office?has_content>
				<@sf.label path="form.${office}" title="Офис(помещение):" required=false style="text-align:right;" colspan=fixFieldsMap["flat_label"]/>
				<@sf.empty colspan=fixFieldsMap["emptyMiddle"]/>
				<@sf.textfield  path="form.${office}" qtip="" validation="maxlength" validationattr={"maxlength":9} style="text-align:left;" colspan=fixFieldsMap["flat_value"]/>
                </#if>
...
<#macro addressSoap label applicant country input settlementRF region area settlement_type streetRF street house corp post  countryCode country_input country_settlement settlement city flat='' office=''>
               <#if applicant==true><${label}><#else><attr><code>${label}</code><stringValue></#if>${dicRegistry.getItemByKey('INSOFT_OKSM', form[country]!'null').name?html}<#if (form[input]!"")=="1" && form[country]?matches("643")>, <@nakhodka.fromKladr settlementRF true "KLADRRegion" "region" /><#else>, ${form[region]}</#if><#if form[post]?has_content>, ${form[post]!''}</#if><#if (form[input]!"")=="1" && form[country]?matches("643")><#if (dicRegistry.getItemByKey('KLADRRegion', form[settlementRF]?substring(0,5)+"000000").name)!=(dicRegistry.getItemByKey('KLADRRegion', form[settlementRF]?substring(0,2)+"000000000").name)>, <@nakhodka.fromKladr settlementRF true "KLADRRegion" "rayon" /></#if><#else>, ${form[area]}</#if><#if (form[input]!"")=="1" && form[country]?matches("643")>, <@nakhodka.fromKladr settlementRF true "KLADRRegion" "gorod" /> <@nakhodka.fromKladr settlementRF false "KLADRRegion" "gorod" /><#else><#if (form[settlement_type]!'')=="1">, ${form[city]!''}<#else>, ${form[settlement]!''}</#if></#if><#if (form[input]!"")=="1" && form[country]?matches("643")><#if form[streetRF]?has_content>, <@nakhodka.fromKladr streetRF true "KLADRStreet" "street" /> <@nakhodka.fromKladr streetRF false "KLADRStreet" "street" /></#if><#else>, ${form[street]!''}</#if><#if form[house]?has_content>, ${form[house]!''}</#if><#if form[corp]?has_content>, ${form[corp]!''}</#if><#if form[flat]?has_content>, ${form[flat]!''}</#if><#if form[office]?has_content>, ${form[office]!''}</#if><#if applicant==true></${label}><#else></stringValue></attr></#if>
</#macro>
