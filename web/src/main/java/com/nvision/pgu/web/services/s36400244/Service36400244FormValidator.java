 ...
 */
@Component
public class Service36400244FormValidator extends AbstractServiceOrderFormValidator<Service36400244Form>
{

    @Override
    public boolean supports(Class< ?> clazz)
    {
        return Service36400244Form.class.isAssignableFrom(clazz);
    }

    @Override
    protected void validate(Service36400244Form form, Integer stepNum, Errors errors) throws RuleException {
