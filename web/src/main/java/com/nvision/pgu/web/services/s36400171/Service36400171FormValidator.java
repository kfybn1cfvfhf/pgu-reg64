 ...
 */
@Component
public class Service36400171FormValidator extends AbstractServiceOrderFormValidator<Service36400171Form>
{

    @Override
    public boolean supports(Class< ?> clazz)
    {
        return Service36400171Form.class.isAssignableFrom(clazz);
    }

    @Override
    protected void validate(Service36400171Form form, Integer stepNum, Errors errors) throws RuleException {
