 ...
 */
@Component
public class Service36400180FormValidator extends AbstractServiceOrderFormValidator<Service36400180Form>
{

    @Override
    public boolean supports(Class< ?> clazz)
    {
        return Service36400180Form.class.isAssignableFrom(clazz);
    }

    @Override
    protected void validate(Service36400180Form form, Integer stepNum, Errors errors) throws RuleException {
        ...
        switch (step) {
			...
			case 4:
				...
				getRuleRegistry().getValidationRule("required").validate(form, errors, "purpose");	
				
					
				
				getRuleRegistry().getValidationRule("required").validate(form, errors, "sertKind");	
				
				getRuleRegistry().getValidationRule("required").validate(form, errors, "sertSeria");	
				
				getRuleRegistry().getValidationRule("required").validate(form, errors, "sertNo");	
				
				getRuleRegistry().getValidationRule("required").validate(form, errors, "sertCat");	
				
				getRuleRegistry().getValidationRule("required").validate(form, errors, "sertOrg");	
				
				getRuleRegistry().getValidationRule("required").validate(form, errors, "sertDate");	
				
					
				
				getRuleRegistry().getValidationRule("required").validate(form, errors, "meddocLoad");	
