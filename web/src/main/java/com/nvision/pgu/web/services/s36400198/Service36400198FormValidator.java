 ...
 */
@Component
public class Service36400198FormValidator extends AbstractServiceOrderFormValidator<Service36400198Form>
{

    @Override
    public boolean supports(Class< ?> clazz)
    {
        return Service36400198Form.class.isAssignableFrom(clazz);
    }

    @Override
    protected void validate(Service36400198Form form, Integer stepNum, Errors errors) throws RuleException {
        ...
        switch (step) {
			...
			case 7:
				...
				getRuleRegistry().getValidationRule("required").validate(form, errors, "houseDocLoad");	
