 ...
 */
@Component
public class Service36400218FormValidator extends AbstractServiceOrderFormValidator<Service36400218Form>
{

    @Override
    public boolean supports(Class< ?> clazz)
    {
        return Service36400218Form.class.isAssignableFrom(clazz);
    }

    @Override
    protected void validate(Service36400218Form form, Integer stepNum, Errors errors) throws RuleException {
        ...
        switch (step) {
			...
			case 6:
				...
				getRuleRegistry().getValidationRule("required").validate(form, errors, "realtyType");	
				
				getRuleRegistry().getValidationRule("required").validate(form, errors, "realtyPlace");	
				
				getRuleRegistry().getValidationRule("required").validate(form, errors, "realtyKadastr");	
