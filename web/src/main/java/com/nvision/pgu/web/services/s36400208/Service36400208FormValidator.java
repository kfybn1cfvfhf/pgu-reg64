 ...
 */
@Component
public class Service36400208FormValidator extends AbstractServiceOrderFormValidator<Service36400208Form>
{

    @Override
    public boolean supports(Class< ?> clazz)
    {
        return Service36400208Form.class.isAssignableFrom(clazz);
    }

    @Override
    protected void validate(Service36400208Form form, Integer stepNum, Errors errors) throws RuleException {
        ...
        switch (step) {
			...
			case 7:
				...
				getRuleRegistry().getValidationRule("required").validate(form, errors, "square");	
				
				getRuleRegistry().getValidationRule("required").validate(form, errors, "landmark");	
				
				getRuleRegistry().getValidationRule("required").validate(form, errors, "purposeUse");	
				
				getRuleRegistry().getValidationRule("required").validate(form, errors, "cadastralRight");	
				
				getRuleRegistry().getValidationRule("required").validate(form, errors, "soughtRight");	
				
				getRuleRegistry().getValidationRule("required").validate(form, errors, "termUse");	
