 ...
 */
@Component
public class Service36400237FormValidator extends AbstractServiceOrderFormValidator<Service36400237Form>
{

    @Override
    public boolean supports(Class< ?> clazz)
    {
        return Service36400237Form.class.isAssignableFrom(clazz);
    }

    @Override
    protected void validate(Service36400237Form form, Integer stepNum, Errors errors) throws RuleException {
        ...
        switch (step) {
			...
			case 7:
				...
				getRuleRegistry().getValidationRule("required").validate(form, errors, "certificateVeteranLoad");	
				
				getRuleRegistry().getValidationRule("required").validate(form, errors, "politicalRepressionLoad");	
				
				getRuleRegistry().getValidationRule("required").validate(form, errors, "pensionCertificateLoad");	
