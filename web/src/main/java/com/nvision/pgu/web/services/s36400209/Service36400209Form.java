...
import ru.atc.idecs.integration.ws.esep.internal.File;
 ...
 *         Time: 7:21:39 PM
 */
public class Service36400209Form extends AbstractServiceOrderForm {
    ...
    public void fillApplicantAttributesWithPrivateRoomData(IPrivateRoomDataContainer privateRoomDataContainer) {
        ...
        this.setAddressFlat(privateRoomDataContainer.getAddressFlat());
            ...
            @InitRule(strategy = ru.lanit.samara.pgu.core.rules.InitRulePersonalDataStrategy.class, field = ru.lanit.samara.pgu.core.rules.InitRulePersonalDataStrategy.PHONE)
			private String phone;
		


            @InitRule(strategy = ru.lanit.samara.pgu.core.rules.InitRulePersonalDataStrategy.class, field = ru.lanit.samara.pgu.core.rules.InitRulePersonalDataStrategy.EMAIL)
			...
			private FileBean listDocLoad;
		

			
			
			private FileBean realtyDocLoad;
			...
			private FileBean realtyEgrpDocLoad;
		

			
			
			private FileBean realtyNoDocLoad;
		

			
			
			private FileBean landEgrpDocLoad;
		

			
			
			private FileBean landNoDocLoad;
		    private FileBean vipUlDocLoad;
    ...
    public void setApplType(String applType) {
			...
			public void setKadastrArea(String kadastrArea) {
					this.kadastrArea = kadastrArea;
				}
			public String getKadastrArea() {
				return this.kadastrArea;
				}
			...
			public String getPermitUse() {
				return this.permitUse;
				}
		

			
			public void setFactUse(String factUse) {
					this.factUse = factUse;
				}
			...
			public void setCapitalRight(String capitalRight) {
					this.capitalRight = capitalRight;
				}
			public String getCapitalRight() {
				return this.capitalRight;
				}
			...
			public void setApproveCh(String approveCh) {
					this.approveCh = approveCh;
				}
			public String getApproveCh() {
				return this.approveCh;
				}
			...
			public void setListDocLoad(FileBean listDocLoad) {
					this.listDocLoad = listDocLoad;
				}
			public FileBean getListDocLoad() {
				return this.listDocLoad;
				}
		

			
			public void setRealtyDocLoad(FileBean realtyDocLoad) {
					this.realtyDocLoad = realtyDocLoad;
				}
			public FileBean getRealtyDocLoad() {
				return this.realtyDocLoad;
				}
			...
			public void setCircsDocLoad(FileBean circsDocLoad) {
					this.circsDocLoad = circsDocLoad;
				}
			public FileBean getCircsDocLoad() {
				return this.circsDocLoad;
				}
			...
			public void setRealtyEgrpDocLoad(FileBean realtyEgrpDocLoad) {
					this.realtyEgrpDocLoad = realtyEgrpDocLoad;
				}
			public FileBean getRealtyEgrpDocLoad() {
				return this.realtyEgrpDocLoad;
				}
		

			
			public void setRealtyNoDocLoad(FileBean realtyNoDocLoad) {
					this.realtyNoDocLoad = realtyNoDocLoad;
				}
			public FileBean getRealtyNoDocLoad() {
				return this.realtyNoDocLoad;
				}
		

			
			public void setLandEgrpDocLoad(FileBean landEgrpDocLoad) {
					this.landEgrpDocLoad = landEgrpDocLoad;
				}
			public FileBean getLandEgrpDocLoad() {
				return this.landEgrpDocLoad;
				}
		

			
			public void setLandNoDocLoad(FileBean landNoDocLoad) {
					this.landNoDocLoad = landNoDocLoad;
				}
			public FileBean getLandNoDocLoad() {
				return this.landNoDocLoad;
				}
    ...
    public FileBean getVipUlDocLoad() {
        return vipUlDocLoad;
    }

    public void setVipUlDocLoad(FileBean vipUlDocLoad) {
        this.vipUlDocLoad = vipUlDocLoad;
    }
}
