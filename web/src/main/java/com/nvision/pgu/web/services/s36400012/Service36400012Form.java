...
public class Service36400012Form extends AbstractServiceOrderForm {
...
//Закладка Тип заявителя
    ...
    public void setOgrnip(FileBean ogrnip) {
        this.ogrnip = ogrnip;
    }

    public FileBean getOgrnip() {
        return this.ogrnip;
    }
