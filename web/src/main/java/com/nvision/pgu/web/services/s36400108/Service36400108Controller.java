 ...
 */
@Controller
@RequestMapping("/services/s" + Service36400108Controller.SERVICE_ID)
@ServiceController(id = Service36400108Controller.SERVICE_ID, title = "Прием заявлений, постановка на учет и предоставление информации об организации оказания специализированной медицинской помощи в специализированных медицинских учреждениях")
@Version("0.4")
public class Service36400108Controller extends AbstractServiceOrderControllerEDS24<Service36400108Form> {
    /**
     ...
     */
    public static final int SERVICE_ID = 36400108;


    @Autowired
    private Service36400108FormValidator validator;

    public Service36400108Controller() {
    ...
    protected void initBinderInternal(WebDataBinder binder)
 	{
 		if (binder.getTarget() instanceof Service36400108Form) {
	...
	@Override
 	protected Service36400108Form createNewForm() {
 		return new Service36400108Form();
 	}

    @Override
    protected void patchModelAndFormOnStepProcessing(Service36400108Form form, Map<String, Object> model, StepProcessingResult stepProcessingResult) {
...
@Override
    protected StepProcessingResult determineNextStepNumOnStepProcessing(Service36400108Form form, boolean goback, Map<String, Object> model) {
    ...
    @Override
       protected Map<String, Object> formToMap(Service36400108Form form) { // вызывается только перед формированием SOAP-запроса в ведомство
     ...
     @Override
    protected List<String> getFormFieldsWithFiles(Service36400108Form form, Map<String, Object> model) {
