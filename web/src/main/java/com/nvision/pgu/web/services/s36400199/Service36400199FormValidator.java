 ...
 */
@Component
public class Service36400199FormValidator extends AbstractServiceOrderFormValidator<Service36400199Form>
{

    @Override
    public boolean supports(Class< ?> clazz)
    {
        return Service36400199Form.class.isAssignableFrom(clazz);
    }

    @Override
    protected void validate(Service36400199Form form, Integer stepNum, Errors errors) throws RuleException {
