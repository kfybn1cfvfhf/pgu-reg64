 ...
 */
@Component
public class Service36400052FormValidator extends AbstractServiceOrderFormValidator<Service36400052Form>
{

    @Override
    public boolean supports(Class< ?> clazz)
    {
        return Service36400052Form.class.isAssignableFrom(clazz);
    }

    @Override
    protected void validate(Service36400052Form form, Integer stepNum, Errors errors) throws RuleException {
