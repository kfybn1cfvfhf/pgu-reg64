 ...
 */
@Component
public class Service36400065FormValidator extends AbstractServiceOrderFormValidator<Service36400065Form>
{

    @Override
    public boolean supports(Class< ?> clazz)
    {
        return Service36400065Form.class.isAssignableFrom(clazz);
    }

    @Override
    protected void validate(Service36400065Form form, Integer stepNum, Errors errors) throws RuleException {
        ...
        switch (step) {
			...
			case 7:
				...
				getRuleRegistry().getValidationRule("required").validate(form, errors, "seatApplicant");	
				...
				getRuleRegistry().getValidationRule("required").validate(form, errors, "centralHeating");	
				
				getRuleRegistry().getValidationRule("required").validate(form, errors, "rightRegister");	
				
				getRuleRegistry().getValidationRule("required").validate(form, errors, "oldHousing");	
				
					
				
				getRuleRegistry().getValidationRule("required").validate(form, errors, "registrationCertificateLoad");	
				
				getRuleRegistry().getValidationRule("required").validate(form, errors, "identitySingleSampleLoad");	
				...
				getRuleRegistry().getValidationRule("required").validate(form, errors, "medicalCommissionLoad");	
				
				getRuleRegistry().getValidationRule("required").validate(form, errors, "houseBookLoad");	
				
				getRuleRegistry().getValidationRule("required").validate(form, errors, "technicalCertificateLoad");	
