 ...
 */
@Component
public class Service36400210FormValidator extends AbstractServiceOrderFormValidator<Service36400210Form>
{

    @Override
    public boolean supports(Class< ?> clazz)
    {
        return Service36400210Form.class.isAssignableFrom(clazz);
    }

    @Override
    protected void validate(Service36400210Form form, Integer stepNum, Errors errors) throws RuleException {
        ...
        switch (step) {
			...
			case 8:
				...
				getRuleRegistry().getValidationRule("required").validate(form, errors, "sootvetsLoad");	
