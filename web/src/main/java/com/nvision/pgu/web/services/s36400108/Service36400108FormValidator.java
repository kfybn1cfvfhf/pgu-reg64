 ...
 */
@Component
public class Service36400108FormValidator extends AbstractServiceOrderFormValidator<Service36400108Form>
{

    @Override
    public boolean supports(Class< ?> clazz)
    {
        return Service36400108Form.class.isAssignableFrom(clazz);
    }

    @Override
    protected void validate(Service36400108Form form, Integer stepNum, Errors errors) throws RuleException {
        ...
        switch (step) {
			...
			case 2:
				...
				getRuleRegistry().getValidationRule("required").validate(form, errors, "gender");	
			...
			case 6:
				...
				getRuleRegistry().getValidationRule("required").validate(form, errors, "recipientBirthPlace");	
				
				getRuleRegistry().getValidationRule("required").validate(form, errors, "recipientGender");	
			...
			case 7:
				...
				getRuleRegistry().getValidationRule("required").validate(form, errors, "noMedPolice");	
				
				getRuleRegistry().getValidationRule("required").validate(form, errors, "nameOrgMedPolice");	
				...
				getRuleRegistry().getValidationRule("required").validate(form, errors, "socStatus");	
				
					
				
				getRuleRegistry().getValidationRule("required").validate(form, errors, "wayDeliveryBenefit");	
				
					
				
				getRuleRegistry().getValidationRule("required").validate(form, errors, "epicrisisDocLoad");	
