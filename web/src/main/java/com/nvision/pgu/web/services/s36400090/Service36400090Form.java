 ...
 *         Time: 7:21:39 PM
 */
public class Service36400090Form extends AbstractServiceOrderForm {
    ...
    private List<FileBean> materialDocLoad = AccessCounterList.createEmpty(FileBean.class);
    private FileBean expertDocLoad;
    private FileBean agreeDocLoad;
    private FileBean accreditationDocLoad;
    private List<FileBean> pravoDocLoad = AccessCounterList.createEmpty(FileBean.class);
    private FileBean planDocLoad;
    private FileBean resolutionDocLoad;
    ...
    public List<FileBean> getMaterialDocLoad() {
        return normalize(materialDocLoad);
    }

    public void setMaterialDocLoad(List<FileBean> materialDocLoad) {
        this.materialDocLoad = AccessCounterList.decorate(materialDocLoad, FileBean.class);
    }
    ...
    public FileBean getAgreeDocLoad() {
        return agreeDocLoad;
    }

    public void setAgreeDocLoad(FileBean agreeDocLoad) {
        this.agreeDocLoad = agreeDocLoad;
    }

    public FileBean getAccreditationDocLoad() {
        return accreditationDocLoad;
    }

    public void setAccreditationDocLoad(FileBean accreditationDocLoad) {
        this.accreditationDocLoad = accreditationDocLoad;
    }
    ...
    public FileBean getResolutionDocLoad() {
        return resolutionDocLoad;
    }

    public void setResolutionDocLoad(FileBean resolutionDocLoad) {
        this.resolutionDocLoad = resolutionDocLoad;
    }
