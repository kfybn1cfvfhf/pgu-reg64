 ...
 */
@Component
public class Service36400051FormValidator extends AbstractServiceOrderFormValidator<Service36400051Form>
{

    @Override
    public boolean supports(Class< ?> clazz)
    {
        return Service36400051Form.class.isAssignableFrom(clazz);
    }

    @Override
    protected void validate(Service36400051Form form, Integer stepNum, Errors errors) throws RuleException {
