 ...
 */
@Component
public class Service36400017FormValidator extends AbstractServiceOrderFormValidator<Service36400017Form>
{

    @Override
    public boolean supports(Class< ?> clazz)
    {
        return Service36400017Form.class.isAssignableFrom(clazz);
    }

    @Override
    protected void validate(Service36400017Form form, Integer stepNum, Errors errors) throws RuleException {
