 ...
 *         Time: 7:21:39 PM
 */
public class Service36400233Form extends AbstractServiceOrderForm {
    ...
    private List<Date> date = AccessCounterList.createEmpty(Date.class);
    private List<Date> from = AccessCounterList.createEmpty(Date.class);
    private List<String> quart = AccessCounterList.createEmpty(String.class);
    private List<String> year = AccessCounterList.createEmpty(String.class);
    ...
    public List<Date> getDate() {
        return normalize(this.date);
    }

    public void setDate(List<Date> date) {
        this.date = AccessCounterList.decorate(date, Date.class);
    }

    public List<Date> getFrom() {
        return normalize(this.from);
    }

    public void setFrom(List<Date> from) {
        this.from = AccessCounterList.decorate(from, Date.class);
    }

    public List<String> getQuart() {
        return normalize(this.quart);
    }

    public void setQuart(List<String> quart) {
        this.quart = AccessCounterList.decorate(quart, String.class);
    }

    public List<String> getYear() {
        return normalize(this.year);
    }

    public void setYear(List<String> year) {
        this.year = AccessCounterList.decorate(year, String.class);
    }
